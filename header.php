...
$arr = array(
    'abm' => array('nombre' => 'ABM', 'contenido' => array(
        ...
        'alicuotas_retenciones' => array('nombre' => 'Alícuotas reten.'),
    ...
    'produccion' => array('nombre' => 'PRODUCCIÓN', 'contenido' => array(
        ...
        'compras' => array('nombre' => 'Compras', 'contenido' => array(
            ...
            'ordenes_compra' => array('nombre' => 'Órdenes de compra', 'contenido' => array(
                'generacion' => array('nombre' => 'Generación OC'),
    ...
    'administracion' => array('nombre' => 'ADMINISTRACIÓN', 'contenido' => array(
        ...
        'tesoreria' => array('nombre' => 'Tesorería', 'contenido' => array(
            ...
            'deposito_bancario' => array('nombre' => 'Depósito bancario', 'contenido' => array(
    ...
    'sistema' => array('nombre' => 'SISTEMA', 'contenido' => array(
        ...
        'notificaciones' => array('nombre' => 'Notificaciones', 'contenido' => array(
            ...
            'usuarios_notificados' => array('nombre' => 'Usuarios notificados'),
...
<div id='divHeader'>
    ...
    <div id='divMenu' class='classMenu'>
        <ul id='ulMenu'>
            <li>
                <div class='menu_koi'><a href='<?php echo Config::siteRoot; ?>'></a></div>
            </li>
            <li>
