...
// print_r($files);
// Filtrar solo archivos de imagen v├ílidos (compatible con PHP 5.2.9)
$image_files = array();
...
// Asignar im├ígenes con valores por defecto si no hay suficientes
...
// Depuraci├│n (compatible con PHP 5.2.9)
...
<html>
  ...
  /* Bot├│n de cambio de empresa (ahora circular) */
  .change-empresa {
    position: absolute;
    top: 15px;
    right: 15px;
    width: 50px; /* Tama├▒o del c├¡rculo */
    height: 50px;
  ...
  .login-box-inner {
    ...
    text-align: center;
    position: relative; /* No m├ís efecto vidriado */
  }
  ...
  #login-error-message {
    ...
    margin-top: 5px
		...
		<script type='text/javascript'>
			...
			function validarLogin(){
				...
				if ($('#pass').val() == ''){
					$('#login-error-message').text('Por favor ingrese una contrase├▒a');
					$('#pass').focus();
					return false;
				}
	...
	<body>
        <div id='full-bg'></div>
        <div class='change-empresa'></div> <!-- C├¡rculo vac├¡o negro con borde blanco -->
		<div id='divBody'>
