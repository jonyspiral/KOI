CREATE VIEW `Pedidos_rentabilidad_v` AS
CREATE VIEW Pedidos_rentabilidad_v
AS
...
FROM         (SELECT PERCENT dbo.pedidos_c.nro_pedido, dbo.pedidos_d.cod_articulo, dbo.pedidos_d.cod_color_articulo, 
