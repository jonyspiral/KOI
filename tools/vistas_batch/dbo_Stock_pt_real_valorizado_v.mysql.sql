CREATE VIEW `Stock_pt_real_valorizado_v` AS
CREATE VIEW Stock_pt_real_valorizado_v
AS
SELECT PERCENT dbo.stock_pt.cod_almacen, dbo.stock_pt.nombre_almacen, dbo.stock_pt.cod_articulo, dbo.stock_pt.nombre_articulo, 
