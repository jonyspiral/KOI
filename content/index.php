							...
							if (not.anulado == 'S') {
								...
								$scope.notificaciones[pos].eliminar = function() {
									if (this.anulado == 'S') {
										...
										//$.error('No se puede eliminar la notificaci�n ya que a�n no se complet� la acci�n');
									} else {
										this.anulado = 'S';
