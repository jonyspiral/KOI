...
function shutdown_content_sistema_auditoria_calificacion_clientes_getPdf_php() {
...
register_shutdown_function('shutdown_content_sistema_auditoria_calificacion_clientes_getPdf_php');
...
if (!$usuario || !$usuario->puede('sistema/auditoria/calificacion_clientes/buscar/')) {
...
try {
    ...
    $html2pdf->tituloReporte = 'Calificacion clientes';
