...
<script>
    ...
    Koi.controller('FavoritosCtrl', function ($scope, ServiceCliente) {
      ...
      $scope.updateLibre = function (articulo, index, talle) {
        ...
        // Guarda el valor inicial al cargar la pÃ¡gina
        ...
        if (articulo.formaDeComercializacion == 'T') {
            ...
            if (!disponible || disponible.cantidad < articulo.paresLibres[index]) {
                ...
                articulo.paresLibres[index] = disponible ? disponible.cantidad : 0; // Revertir al valor anterior o al mÃ¡ximo permitido
                return false;
            }
        }
    ...
    $scope.removeAllFavs = async function () {
      ...
      /* No funcionarÃ­a si lo descomentara, porque cambiÃ³ la estructura de $scope.favoritos (ahora tiene idLinea)
