...
$js = array(
    ...
    'post' => array(
        ...
        'js/directives/item-stock.js',
        'js/directives/gallery-modal.js',
        'js/directives/modal-tres-d.js',
        'js/directives/stock-produccion.js',
...
<html ng-app='Koi'>
    <head>
        ...
        <script type='text/javascript'>
          ...
          //Prevengo que apretar BACKSPACE vuelva a la p�gina anterior
    ...
    <body>
        ...
        <div id="modal-3d" class="modal fade">
           <button type="button" class="modal-close close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <div id="modal-iframe-3d"></div>
        </div>

        <div class="modal fade bs-example-modal-sm" id="modal-sizes" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title">Tabla de talles</h4>
              </div>
              <div class="modal-body">
                <table class="table table-bordered" id="table-talles">
                  <thead>
                  </thead>
                  <tbody>
                  </tbody>
        ...
        <div class="modal fade bs-example-modal-lg" id="gallery-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title" style="display: none">Galeria</h4>
              </div>
              <div class="modal-body">
                ...
                <div id="carousel-gallery" class="carousel slide">
                  ...
                  <a class="left carousel-control" id="carousel-gallery-prev" href="#carousel-gallery" role="button" data-slide="prev">
                    <span class="glyphicon glyphicon-chevron-left control-carrusel control-carrusel-izq"></span>
                    <span class="sr-only">Previous</span>
                  </a>
                  <a class="right carousel-control" id="carousel-gallery-next" href="#carousel-gallery" role="button" data-slide="next">
                    <span class="glyphicon glyphicon-chevron-right control-carrusel control-carrusel-der"></span>
