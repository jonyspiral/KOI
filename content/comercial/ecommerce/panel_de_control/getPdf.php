...
function comercialPdfFatalHandler_ecommerce_panel_de_control() {
...
register_shutdown_function('comercialPdfFatalHandler_ecommerce_panel_de_control');
...
if (!$usuario || !$usuario->puede('comercial/ecommerce/panel_de_control/buscar/')) {
