...
function shutdown_content_administracion_cobranzas_reportes_comisiones_getPdf_php() {
...
register_shutdown_function('shutdown_content_administracion_cobranzas_reportes_comisiones_getPdf_php');
...
if (!$usuario || !$usuario->puede('administracion/cobranzas/reportes/comisiones/buscar/')) {
