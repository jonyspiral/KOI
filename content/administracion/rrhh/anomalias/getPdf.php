...
function shutdown_content_administracion_rrhh_anomalias_getPdf_php() {
...
register_shutdown_function('shutdown_content_administracion_rrhh_anomalias_getPdf_php');
...
if (!$usuario || !$usuario->puede('administracion/rrhh/anomalias/buscar/')) {
