...
function shutdown_content_administracion_rrhh_fichajes_getPdf_php() {
...
register_shutdown_function('shutdown_content_administracion_rrhh_fichajes_getPdf_php');
...
if (!$usuario || !$usuario->puede('administracion/rrhh/fichajes/buscar/')) {
