...
function shutdown_content_administracion_contabilidad_libro_diario_getPdf_php() {
...
register_shutdown_function('shutdown_content_administracion_contabilidad_libro_diario_getPdf_php');
...
if (!$usuario || !$usuario->puede('administracion/contabilidad/libro_diario/buscar/')) {
