...
function shutdown_content_administracion_finanzas_reportes_facturacion_por_jurisdiccion_getPdf_php() {
...
register_shutdown_function('shutdown_content_administracion_finanzas_reportes_facturacion_por_jurisdiccion_getPdf_php');
...
if (!$usuario || !$usuario->puede('administracion/finanzas/reportes/facturacion_por_jurisdiccion/buscar/')) {
...
try {
	...
	$html2pdf->tituloReporte = 'Reporte FacturaciÃƒÂ³n Por JurisdicciÃƒÂ³n';
