...
function shutdown_content_administracion_tesoreria_reportes_egreso_de_fondos_getPdf_php() {
...
register_shutdown_function('shutdown_content_administracion_tesoreria_reportes_egreso_de_fondos_getPdf_php');
...
if (!$usuario || !$usuario->puede('administracion/tesoreria/reportes/egreso_de_fondos/buscar/')) {
