...
function shutdown_content_administracion_tesoreria_reportes_retiro_aporte_socio_getPdf_php() {
...
register_shutdown_function('shutdown_content_administracion_tesoreria_reportes_retiro_aporte_socio_getPdf_php');
...
if (!$usuario || !$usuario->puede('administracion/tesoreria/reportes/retiro_aporte_socio/buscar/')) {
