...
function shutdown_content_administracion_cajas_resumen_bancario_getPdf_php() {
...
register_shutdown_function('shutdown_content_administracion_cajas_resumen_bancario_getPdf_php');
...
if (!$usuario || !$usuario->puede('administracion/cajas/resumen_bancario/buscar/')) {
