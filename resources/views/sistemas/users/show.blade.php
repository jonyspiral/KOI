...
@section('content')
<div class="container">
    <h2 class="mb-4">👁️ Detalle de User</h2>
    ...
    <a href="{{ route('sistemas.abms.user.index') }}" class="btn btn-secondary">⬅️ Volver</a>
    <a href="{{ route('sistemas.abms.user.edit', $registro[$primaryKey]) }}" class="btn btn-primary">✏️ Editar</a>
</div>
@endsection
