...
@section('content')
<div class="container">
    <h2 class="mb-4">👁️ Detalle de Almacen</h2>
    ...
    <a href="{{ route('produccion.abms.almacenes.index') }}" class="btn btn-secondary">⬅️ Volver</a>
    <a href="{{ route('produccion.abms.almacenes.edit', $registro[$primaryKey]) }}" class="btn btn-primary">✏️ Editar</a>
</div>
@endsection
