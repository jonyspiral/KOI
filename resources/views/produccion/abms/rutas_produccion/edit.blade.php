...
<div class="container">
    ...
    <form action="{{ route('produccion.abms.rutas_produccion.update', $registro->id) }}" method="POST">
        @csrf
...
@endforeach
        ...
        <a href="{{ route('produccion.abms.rutas_produccion.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Cancelar</a>
    </form>
</div>
@endsection 
