...
<div class="container">
    ...
    <form action="{{ route('produccion.abms.pasos_rutas_produccion.store') }}" method="POST">
        @csrf
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('produccion.abms.pasos_rutas_produccion.index') }}" class="btn btn-secondary">⬅️ Cancelar</a>
        </div>
    </form>
</div>
@endsection
