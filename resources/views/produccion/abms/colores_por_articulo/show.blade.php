...
@section('content')
<div class="container">
    <h2 class="mb-4">👁️ Detalle de ColoresPorArticulo</h2>
    ...
    <a href="{{ route('produccion.abms.colores_por_articulo.index') }}" class="btn btn-secondary">⬅️ Volver</a>
    <a href="{{ route('produccion.abms.colores_por_articulo.edit', $registro[$primaryKey]) }}" class="btn btn-primary">✏️ Editar</a>
</div>
@endsection
