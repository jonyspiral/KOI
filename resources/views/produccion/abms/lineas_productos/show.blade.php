...
@section('content')
<div class="container">
    <h2 class="mb-4">👁️ Detalle de LineasProducto</h2>
    ...
    <a href="{{ route('produccion.abms.lineas_producto.index') }}" class="btn btn-secondary">⬅️ Volver</a>
    <a href="{{ route('produccion.abms.lineas_producto.edit', $registro[$primaryKey]) }}" class="btn btn-primary">✏️ Editar</a>
</div>
@endsection
