...
@section('content')
<div class="container">
    <h2 class="mb-4">👁️ Detalle de SeccionesProduccion</h2>
    ...
    <a href="{{ route('produccion.abms.secciones_produccion.index') }}" class="btn btn-secondary">⬅️ Volver</a>
    <a href="{{ route('produccion.abms.secciones_produccion.edit', $registro[$primaryKey]) }}" class="btn btn-primary">✏️ Editar</a>
</div>
@endsection
