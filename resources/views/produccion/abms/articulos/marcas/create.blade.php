...
<div class="container">
    ...
    <form action="{{ route('produccion.abms.articulos.marcas.store') }}" method="POST">
        @csrf
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('produccion.abms.articulos.marcas.index') }}" class="btn btn-secondary">⬅️ Cancelar</a>
        </div>
    </form>
</div>
@endsection
