...
<div class="container">
    ...
    <form action="{{ route('produccion.abms.articulos.marcas.update', $registro[$primaryKey]) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('produccion.abms.articulos.marcas.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Cancelar</a>
        </div>
    </form>
</div>
@endsection
