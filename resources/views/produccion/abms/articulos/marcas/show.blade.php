...
<div class="container">
    ...
    <a href="{{ route('produccion.abms.articulos.marcas.index') }}" class="btn btn-secondary">⬅️ Volver</a>
    <a href="{{ route('produccion.abms.articulos.marcas.edit', $registro[$primaryKey]) }}" class="btn btn-primary">✏️ Editar</a>
</div>
@endsection
