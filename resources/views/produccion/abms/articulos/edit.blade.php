...
<div class="container">
    ...
    <form action="{{ route('produccion.abms.articulo.update', $registro[$primaryKey]) }}" method="POST">
        @csrf
        @method('PUT')
...
@endforeach
        ...
        <div class="mt-4">
            ...
            <a href="{{ route('produccion.abms.articulo.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Cancelar</a>
        </div>
    </form>
</div>
@endsection
