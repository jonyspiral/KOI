...
<div class="container">
    ...
    <a href="{{ route('produccion.abms.index') }}" class="btn btn-secondary">⬅️ Volver</a>
    <a href="{{ route('produccion.abms.edit', $registro[$primaryKey]) }}" class="btn btn-primary">✏️ Editar</a>
</div>
@endsection
