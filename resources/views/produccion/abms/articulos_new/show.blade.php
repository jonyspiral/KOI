...
@section('content')
<div class="container">
    <h2 class="mb-4">👁️ Detalle de ArticulosNew</h2>
    ...
    <a href="{{ route('produccion.abms.articulos_new.index') }}" class="btn btn-secondary">⬅️ Volver</a>
    <a href="{{ route('produccion.abms.articulos_new.edit', $registro[$primaryKey]) }}" class="btn btn-primary">✏️ Editar</a>
</div>
@endsection
