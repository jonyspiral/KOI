...
<div class="container">
    ...
    <form action="{{ route('produccion.abms.familias_producto.update', $registro->id) }}" method="POST">
        @csrf
...
@endforeach
        ...
        <a href="{{ route('produccion.abms.familias_producto.index') }}" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Cancelar</a>
    </form>
</div>
@endsection 
