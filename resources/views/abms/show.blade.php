...
@section('content')
<div class="container">
    <h2 class="mb-4">👁️ Detalle de TipoProductoStock</h2>
    ...
    <a href="{{ route('produccion.abms.tipo_producto_stock.index') }}" class="btn btn-secondary">⬅️ Volver</a>
    <a href="{{ route('produccion.abms.tipo_producto_stock.edit', $registro[$primaryKey]) }}" class="btn btn-primary">✏️ Editar</a>
</div>
@endsection
