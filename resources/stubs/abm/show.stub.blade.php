...
@section('content')
<div class="container">
    <h2 class="mb-4">👁️ Detalle de __MODELO__</h2>
    ...
    <a href="{{ route('__NOMBRE_RUTA__.index') }}" class="btn btn-secondary">⬅️ Volver</a>
    <a href="{{ route('__NOMBRE_RUTA__.edit', $registro[$primaryKey]) }}" class="btn btn-primary">✏️ Editar</a>
</div>
@endsection
