...
class RutasProduccionController extends Controller
{
    public function index()
    {
        ...
        return view('produccion/rutas_produccion.index', compact('registros', 'modelo'));
    }

    public function create()
    {
        $modelo = 'Rutas Produccion';
        return view('produccion/rutas_produccion.form', compact('modelo'));
    }

    public function store(Request $request)
    {
        RutasProduccion::create($request->only(['cod_ruta', 'denom_ruta', 'anulado', 'created_at', 'updated_at', 'sync_status']));
        return redirect()->route('produccion.rutas_produccion.index');
    }
    ...
    public function edit($id)
    {
        ...
        $modelo = 'Rutas Produccion';
        return view('produccion/rutas_produccion.form', compact('registro', 'modelo'));
    }
