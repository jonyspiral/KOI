    ...
    public function index(Request $request)
{
    ...
    $carpeta_vistas = $config['carpeta_vistas'] ?? 'produccion/abms/secciones_produccions';

    $query = SeccionesProduccion::query();
   ...
   // $perPage = max(10, min($perPage, 500));
    ...
    public function create()
    {
        ...
        foreach ($campos as $campo => $meta) {
            ...
            if (($meta['input_type'] ?? null) === 'autonumerico') {
                $siguiente[$campo] = SeccionesProduccion::max($campo) + 1;
            }
        ...
        return view('produccion/abms/secciones_produccion.create', compact(
    ...
    public function edit($id)
    {
        ...
        return view('produccion/abms/secciones_produccion.edit', compact(
    ...
    public function store(Request $request)
    {
        ...
        foreach ($campos as $campo => $meta) {
            ...
            if (($meta['input_type'] ?? null) === 'autonumerico') {
                $valor = SeccionesProduccion::max($campo) + 1;
...
try {
    ...
    public function update(Request $request, $id)
    {
        ...
        $redirect = $this->redirectToParent($request, 'SeccionesProduccion');
        return $redirect ?? redirect()->route('produccion.abms.secciones_produccion.index')->with('success', 'Actualizado correctamente.');
    }
