    ...
    public function index(Request $request)
{
   ...
   // $perPage = max(10, min($perPage, 500));
    ...
    public function create()
    {
        ...
        foreach ($campos as $campo => $meta) {
            ...
            if (($meta['input_type'] ?? null) === 'autonumerico') {
                $siguiente[$campo] = Horma::max($campo) + 1;
            }
    ...
    public function store(Request $request)
    {
        ...
        $redirect = $this->redirectToParent($request, 'Horma');
        return $redirect ?? redirect()->route('produccion.abms.hormas.index')->with('success', 'Guardado correctamente.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $redirect = $this->redirectToParent($request, 'Horma');
        return $redirect ?? redirect()->route('produccion.abms.hormas.index')->with('success', 'Actualizado correctamente.');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $registro = Horma::where('id', $id)->firstOrFail();
        ...
        return $this->redirectToParent($request->merge($registro->toArray()), $modeloNombre)
            ?? redirect()->route('produccion.abms.hormas.index')->with('success', 'Registro eliminado correctamente.');
    }
