...
<div id="cabecera">
	...
	<div id="c3">
		...
		<span id="numerosCabecera" class="textoSize07 absolute">C.U.I.T Nº <?php echo Funciones::ponerGuionesAlCuit(Config::CUIT_RTG); ?><BR/>ING. BRUTOS Nº <?php echo Funciones::ponerGuionesAlCuit(Config::CUIT_RTG); ?><BR/>INICIO DE ACTIVIDADES: 04/2007</span>
	</div>
</div>
